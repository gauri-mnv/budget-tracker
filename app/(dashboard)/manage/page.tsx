...
function page() {
  return (
    ...
    px-4 flex flex-wrap items-center justify-between gap-4 py-8">
      ...
      <div className="container flex flex-col gap-4 p-4  mx-auto max-w-10xl">
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              {type === "expense" ? <TrendingDown className="h-12 w-12 items-center rounded-lg bg-rose-400/10 p-2 text-rose-500"  /> :  <TrendingUp className="h-12 w-12 items-center rounded-lg bg-emerald-400/10 p-2 text-emerald-500"  />}
