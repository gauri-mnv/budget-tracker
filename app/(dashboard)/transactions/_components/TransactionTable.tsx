    ...
    cell: ({ row }) => (
      <div className="flex gap-2 capitalize">
        ...
        <div className="captalize">
          {row.original.category ? row.original.category : "Uncategorized"}
        </div>
      </div>
    ),
  },
...

{
    ...
    cell: ({ row }) => (
      <div className={cn("capitalize rounded-lg p-2 text-center",
...
const [columnFilters, setColumnFilters] = useState<ColumnFiltersState>([]);
  ...
  const categorriesOptions=useMemo(()=>{
  ...
  return (
    // <div className="w-full">
       <div className="container mx-auto max-w-7xl px-10 py-6">
      {/* <pre>
        {
          JSON.stringify(categorriesOptions, null, 2)
        }
      </pre> */}
